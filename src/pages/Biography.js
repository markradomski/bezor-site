	...
	<Main heading="Biography">
		<div className="cv">
			...
			<table className="table">
				<tbody className="">
					<tr>
						<td className="duration">2019</td>
						<td className="content">Ricochet, Hill Smith Galleries, Adelaide </td>
					</tr>
					<tr>
						<td className="duration">2019</td>
						<td className="content">
							Ricochet<sup>2</sup>, Aptos Cruz Galleries, Stirling, South Australia{' '}
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td className="content">Survey show 1997 - 2013, Coffs Harbour Regional Gallery, NSW</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td className="content">Flogging the rocking horse, Greenaway Art Gallery, Adelaide</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td className="content">Cloning the ultimate appropriation, Greenaway Art Gallery, Adelaide</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td className="content">Adelaide Festival Exhibition, Greenaway Art Gallery, Adelaide</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td className="content">Beyond the Veil, Roslyn Oxley 9 and Contemporary Art Centre, Adelaide</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td className="content">
							A Survey, Contemporary Art Centre, Adelaide and touring; Imago Ignota, Luba Bilu Gallery, Melbourne.
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table className="table ">
				<tbody className="">
					<tr>
						<td className="duration">2019</td>
						<td className="content">Figurative Works, Annette Bezor & Anna Platten, Hill Smith Galleries, Adelaide</td>
					</tr>
					<tr>
						<td className="duration">2018</td>
						<td className="content">She Talks To Rainbows, Adelaide Airport Art at T2, Adelaide</td>
					</tr>
					<tr>
						<td className="duration">2017</td>
						<td className="content">Trace, Hill Smith Galleries, Adelaide </td>
					</tr>
					<tr>
						<td className="duration">2017</td>
						<td className="content">4 Decades, 6 Artists, (FRAN Festival), Hill Smith Galleries, Adelaide </td>
					</tr>
					<tr>
						<td className="duration">2016</td>
						<td className="content">Art Central Hong Kong, Hill Smith Galleries Booth, HK</td>
					</tr>
					<tr>
						<td className="duration">2014</td>
						<td className="content">Australia Day Exhibition, Australian Galleries, Melbourne & Sydney</td>
					</tr>
					<tr>
						<td className="duration">2012</td>
					...
					<tr>
						<td className="duration">2004</td>
						<td className="content">ARCO 2004 (International Art Fair), Greenaway Art Gallery, Madrid, Spain</td>
					</tr>
					<tr>
						<td className="duration">2004</td>
						<td className="content">Annette Bezor. Carolina Antich. Florence Lynch Gallery, New York</td>
					</tr>
					<tr>
						<td className="duration">2002</td>
					...
					<tr>
						...
						<td className="content">ARCO 98 (International Art Fair), Greenaway Art Gallery, Madrid, Spain</td>
					</tr>
					<tr>
						<td className="duration">1998</td>
						<td className="content">Adelaide Festival Exhibition, Greenaway Art Gallery, Adelaide</td>
					...
					<tr>
						...
						<td className="content">ARCO 96 (International Art Fair) Greenaway Art Gallery, Madrid, Spain</td>
					</tr>
					<tr>
						<td className="duration">1994</td>
						<td className="content">
							John McCaughey Memorial Art Prize Exhibition, National Art Gallery of Victoria, Melbourne
						</td>
					</tr>
					<tr>
						<td className="duration">1992</td>
					...
					<tr>
						<td className="duration">1992</td>
						<td className="content">The Nude 1992 - Sara Weis Award, Heide Park and Art Gallery</td>
					</tr>
					<tr>
						<td className="duration">1992</td>
					...
					<tr>
						...
						<td className="content">Voyage of Discovery Australian Painting and Sculpture, Crescent Gallery, Dallas</td>
					</tr>
					<tr>
						<td className="duration">1987</td>
					...
					<tr>
						<td className="duration">1983</td>
						<td className="content">Against The Wall Young Contemporary Artists National Gallery of Victoria</td>
					</tr>
					<tr>
						<td className="duration">1983</td>
						<td className="content">McCaughey Memorial Art Prize Exhibition National Gallery of Victoria</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td className="content">Round Space Members, Union Gallery, University of Adelaide.</td>
					</tr>
					<tr>
			...
			<table className="table ">
				<tbody className="">
					...
					<tr>
						<td className="duration">1999</td>
						<td className="content">Finalist, The Portia Geach Memorial Award, S.H. Ervin, Sydney</td>
					</tr>
					<tr>
						<td className="duration">1994</td>
						<td className="content">Finalist, John McCaughey Memorial Art Prize, NGV, Melbourne</td>
					</tr>
					<tr>
						<td className="duration">1993</td>
						<td className="content">Finalist, The Portia Geach Memorial Award, S.H. Ervin, Sydney</td>
					...
					<tr>
						<td className="duration">1992</td>
						<td className="content">First Prize, Sara Weis Award, Heidi Museum of Modern Art, VIC</td>
					</tr>
					<tr>
						<td className="duration">1992</td>
						<td className="content">Finalist, The Sir John Sulman Prize, AGNSW, Sydney</td>
					...
					<tr>
						<td className="duration">1977</td>
						<td className="content">John Christie Wright Memorial Prize for Life Drawing and Painting</td>
					</tr>
				</tbody>
			</table>
			<SectionHeading>
			...
			<table className="table ">
				<tbody className="">
					...
					<tr>
						<td className="duration">2003</td>
						<td className="content">International Assistance Grant, Visual Arts Board, Australia Council</td>
					</tr>
					<tr>
						<td className="duration">2002</td>
			...
			<table className="table ">
				<tbody className="">
					<tr>
						<td className="duration">1994</td>
						<td className="content">Victorian Parliament: Portrait of Joan Kirner, Victorian Premier '90-'92</td>
					</tr>
					<tr>
						<td className="duration">1982</td>
						<td className="content">South Australian Government: Entrance foyer, Adelaide Law Courts</td>
					</tr>
				</tbody>
			</table>
			<SectionHeading>
			...
			<table className="table ">
				<tbody className="">
					<tr>
						<td className="duration">2007</td>
						<td className="content">Annette Bezor: Painted Women. Ted Snell. Turner Galleries Exhib. Essay, Nov/Dec</td>
					</tr>
					<tr>
						<td className="duration">2007</td>
						<td className="content">Chris Reid. Florence Lynch Exhibition catalogue. New York Jan/Feb</td>
					</tr>
					<tr>
						<td className="duration">2004</td>
					...
					<tr>
						<td className="duration">2003</td>
						<td className="content">Juliette Peers, Florence Lynch Gallery exhibition catalogue, May/June</td>
					</tr>
					<tr>
						<td className="duration">2003</td>
						<td className="content">M A Greenstein, Florence Lynch Gallery exhibition catalogue, May/June</td>
					</tr>
					<tr>
						<td className="duration">2002</td>
					...
					<tr>
						<td className="duration">2002</td>
						<td className="content">Survey of SA talent. Wendy Walker. The Advertiser, 7 August</td>
					</tr>
					<tr>
						<td className="duration">2002</td>
					...
					<tr>
						<td className="duration">2002</td>
						<td className="content">Filmic thematic at IMA. Barbara Bolt. Real Time. April/May</td>
					</tr>
					<tr>
						<td className="duration">2001</td>
						<td className="content">The gaze of Aphrodite, Karen Kissane. The Age, September 23</td>
					</tr>
					<tr>
						<td className="duration">2001</td>
					...
					<tr>
						<td className="duration">1999</td>
						<td className="content">Panoramic perspective of artist's state. Peter Ward. The Australian. July 30</td>
					</tr>
					<tr>
						<td className="duration">1999</td>
						<td className="content">SurFace Tension, Chris Reid, Catalogue essay, Robert Lindsay Gallery</td>
					</tr>
					<tr>
						<td className="duration">1996</td>
						<td className="content">Richard Grayson, Blind, Greenaway Art Gallery, ARCO 96 Catalogue</td>
					</tr>
					<tr>
						<td className="duration">1995</td>
						<td className="content">Richard Grayson, Robert Lindsay Gallery Catalogue, February</td>
					</tr>
					<tr>
						<td className="duration">1992</td>
						<td className="content">
							Felicity Fenner, Sexuality in the work of six contemporary women painters, Art and Australia, Volume 30,
							No. 1, Spring
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td className="duration">1991</td>
						<td className="content">
							Jyanni Steffensen, A Desire of One's Own: The Politics and Poetics of Female (Erotic) Representation in
							Annette Bezor's Paintings, Annette Bezor 1980-1991, Contemporary Art Centre of South Australia, Adelaide
						</td>
					</tr>
					<tr>
						<td className="duration">1991</td>
					...
					<tr>
						<td className="duration">1991</td>
						<td className="content">
							Timothy Morrell, Ecstasy/Excess, Annette Bezor 1980-1991, Contemporary Art Centre of South Australia,
							Adelaide
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td className="duration">1990</td>
						<td className="content">Timothy Morrell, Ecstasy/Excess: Annette Bezor, Art & Australia</td>
					</tr>
					<tr>
						<td className="duration">1989</td>
						<td className="content">Ashley Crawford The bare kitsch of Bezor's women. The Herald,18th July</td>
					</tr>
					<tr>
						<td className="duration">1989</td>
						<td className="content">Ronald Miller Using black at its best, The Herald 8th August</td>
					</tr>
					<tr>
						<td className="duration">1989</td>
					...
					<tr>
						<td className="duration">1988</td>
						<td className="content">John Neylon, Staying on the Edge The Adelaide Review, August</td>
					</tr>
					<tr>
						<td className="duration">1988</td>
					...
					<tr>
						<td className="duration">1987</td>
						<td className="content">1987 Elaine Merkus, Here and There, Monash University Gallery, Melbourne</td>
					</tr>
					<tr>
						<td className="duration">1986</td>
						<td className="content">Neville Weston, Bezor keeps her head above water. The Advertiser 24th April</td>
					</tr>
					<tr>
						<td className="duration">1986</td>
						<td className="content">
					...
					<tr>
						<td className="duration">1983</td>
						<td className="content">Bernice Murphy, Australian Perspecta 83, Art Gallery of NSW, Sydney</td>
					</tr>
					<tr>
						<td className="duration">1983</td>
						<td className="content">Neville Weston, Eve's symbolic garden The Advertiser 26thOct, Adelaide</td>
					</tr>
					<tr>
						<td className="duration">1983</td>
						<td className="content">
							Robert Lindsay Against the Wall: Young Contemporary Artists selected from the Michell Endowment of the
							National Gallery of Victoria (broadsheet catalogue)
						</td>
					</tr>
					<tr>
						<td className="duration">1981</td>
						<td className="content">The Editors Who are Australia's Young Artists? Vogue Living, April/May</td>
					</tr>
				</tbody>
			</table>
			<SectionHeading>
